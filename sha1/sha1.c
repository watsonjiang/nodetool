...
Routine SHA1Update changed from
	void SHA1Update(aae_SHA1_CTX* context, unsigned char* data, unsigned int
len)
to
	void SHA1Update(aae_SHA1_CTX* context, unsigned char* data, unsigned
long len)
...
#ifdef VERBOSE  /* SAK */
static
void SHAPrintContext(aae_SHA1_CTX *context, char *msg){
